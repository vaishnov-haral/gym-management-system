...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<spring:url value='/admin/admin_dashboard'/>">${sessionScope.trainerDetails.name}</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="<spring:url value='/trainer/trainer_dashboard'/>">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="layout">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#layout" data-parent="#exampleAccordion">
            ...
            <li>  
              <a href="<spring:url value='/trainer/add_diet'/>"> <i class="fa fa-fw fa-link"></i> Add Diet</a>
            </li>
            <li>
              <a href="<spring:url value='/trainer/checkDiet'/>"><i class="fa fa-fw fa-link"></i> Check Diet</a>
            </li>
              <li>  
              <a href="<spring:url value='/trainer/addExcercise'/>"> <i class="fa fa-fw fa-link"></i> Add Excercise</a>
            </li>
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="vendor">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#vendor" data-parent="#exampleAccordion">
            ...
            <li>  
              <a href="<spring:url value='/trainer/show_details'/>">  <i class="fa fa-fw fa-file"></i> Member Details</a>
            </li>
            <li>
              <a href="<spring:url value='/trainer/member_registration'/>"><i class="fa fa-fw fa-file"></i>Member Registration</a>
            </li>
